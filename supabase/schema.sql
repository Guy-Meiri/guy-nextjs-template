...
-- Note: User data is managed by NextAuth.js in the next_auth schema
-- Add your application-specific tables here as needed

-- Example: If you need additional user profile data beyond NextAuth.js
